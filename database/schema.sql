...
-- Projects table - Top level of your hierarchy
...
-- Stories table - Belongs to Projects
...
-- Chapters table - Belongs to Stories
...
-- Sections table - Belongs to Chapters
...
-- Comments table - Can be attached to any entity
...
-- Project_Users table - For collaboration (who can access which projects)
